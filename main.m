...
clear;
run C:\Users\Andy\Desktop\vlfeat-0.9.20/toolbox/vl_setup
...
for i = 2: size(H_list, 2) + 1
    homographies{i} = homographies{i-1} * H_list{i - 1};
    %H21 = H_list{1} * eye(3);
    %H31 = H_list{2} * H21;
    %H41 = H_list{3} * H31;
end 
H_map = homographies;
%H_map = {eye(3), H21, H31, H41};
...
imwrite(panorama_image, 'arzietlow.jpg');
